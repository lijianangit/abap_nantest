...
initialization."在程序开始执行时初始化数据时触发。
  ...
  parameters:p_matnr  type matnr  default '000000000000010687' obligatory.

  parameters:p_ekorg  type ekorg default '' .

  parameters:p_werks  type werks_d default 'H101' obligatory .

  parameters:lgort_d  type z_lgort  default '1001' obligatory.

  parameters:p_eeind  type sy-datum  obligatory .
